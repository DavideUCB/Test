...
buttonSaveTab2.grid(row=1, column=0, padx=15, pady=15)
buttonRunTab2.grid(row=2, column=0, padx=15, pady=15)
buttonResetTab2.grid(row=3, column=0, padx=15, pady=15)
