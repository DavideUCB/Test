...
try:
    ...
    import requests
       token = os.getenv('GITHUB_TOKEN', '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')
        headers = {
            'Authorization': f'token {token}',
            'Accept': 'application/vnd.github.v3.raw'}
        r = requests.get('https://raw.githubusercontent.com/DavideUCB/Test/main/requirement.txt', headers=headers)
    data=r.text
